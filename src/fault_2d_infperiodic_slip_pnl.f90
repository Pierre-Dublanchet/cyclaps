...
program fault_2d_infperiodic_slip_pnl

use mod_cst_fault_rns
use mod_cst_fault_rns_p
use netcdf
implicit none
integer :: iter,i,i_inj
...
real*8, dimension(:), allocatable :: kappa_proc,sk_proc,tbp_proc
...
allocate(kappa_proc(cc%nvalpr),sk_proc(cc%nvalpr),tbp_proc(cc%nvalpr))
...
!-------------------------------------------------------------------------------------------------------------------!
 call init_rns_2d_rg_p(a_proc,b_proc,dc_proc,s_proc,phi_proc,th_proc,u_proc,p_proc,cm,cc,cr)
 t=0.0
 tex(1)=0.0
 tex(2)=0.0
 tex(3)=0.0
 ...
 call normalize_rns_p(a_proc,b_proc,dc_proc,s_proc,u_proc,phi_proc,th_proc,p_proc,cm,chy,cc,cr)
   ...
   !---------------------------------------------------------------------------------------------!
  call elastic_kernel_2d_infperiodic(kappa_proc,cc,cm)
...
do iter=1,cc%niter
 ...
 call rk4f_2d_infperiodic_slip_pnl(t,phi_proc,th_proc,kappa_proc,&
...
end program fault_2d_infperiodic_slip_pnl

include 'param_fault_rns_p.f90'
include 'init_rns_2d_rg_p.f90'
include 'renewoutfiles.f90'
include 'normalize_rns_p.f90'
include 'tbp_rns_2d_infperiodic.f90'
include 'ci2x_2d_rg.f90'
include 'x2ci_2d_rg.f90'
include 'frns_slip_p.f90'
include 'grns_slip_p.f90'
include 'elastic_kernel_2d_infperiodic.f90'
include 'lin_static_stress_periodic.f90'
include 'rk4f_2d_infperiodic_slip_pnl.f90'
