...
subroutine rk4f_2d_cr_regage_pnl(t,phi_proc,th_proc,kappa_proc,v0_proc,rkr,rks,ad,&
...
real*8 :: t,dt,ddt,dt0
real*8 :: frns_regage_p,grns_age_p
real*8 :: p0,pe,d0,de
...
do while ((passtep .eq. 0) .and. (iterrk .le. cc%paramdt(1)))
  ...
  do i=1,cc%nvalpr
        l1_proc(i)=frns_regage_p(phi_proc(i),th_proc(i),sk_proc(i),tbp_proc(i),p_proc(i),k1_proc(i),&
...
ddt=cc%rka(2)*dt
  ...
  do i=1,cc%nvalpr
        l2_proc(i)=frns_regage_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
...
ddt=cc%rka(3)*dt
  ...
  do i=1,cc%nvalpr
        l3_proc(i)=frns_regage_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
...
ddt=cc%rka(4)*dt
 ...
 call diffu(diffu_proc,phi_proc+dphi_proc,th_proc+dth_proc,p_proc+dp_proc,&
  ...
  do i=1,cc%nvalpr
        l4_proc(i)=frns_regage_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
...
ddt=cc%rka(5)*dt
 ...
 call diffu(diffu_proc,phi_proc+dphi_proc,th_proc+dth_proc,p_proc+dp_proc,&
  ...
  do i=1,cc%nvalpr
        l5_proc(i)=frns_regage_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
...
ddt=cc%rka(6)*dt
 ...
 call diffu(diffu_proc,phi_proc+dphi_proc,th_proc+dth_proc,p_proc+dp_proc,&
  ...
  do i=1,cc%nvalpr
        l6_proc(i)=frns_regage_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
...
end subroutine rk4f_2d_cr_regage_pnl
