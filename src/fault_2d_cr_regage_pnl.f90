...
program fault_2d_cr_regage_pnl
...
do iter=1,cc%niter
 ...
 call rk4f_2d_cr_regage_pnl(t,phi_proc,th_proc,kappa_proc,v0_proc,rkr,rks,ad,&
...
end program fault_2d_cr_regage_pnl
