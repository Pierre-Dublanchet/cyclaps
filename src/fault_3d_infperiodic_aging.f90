...
program fault_3d_infperiodic_aging
...
do iter=1,cc%niter
  ...
  !--------------------------------------------------------------------------------------------------------!
  if (cr%catal .eq. 1) then   
      call reccatal_3d_rg(cc,cm,cr,phi_proc,th_proc,tau_proc,u_proc,s_proc,a_proc,b_proc,irecevt,t,vmax,isevt,&
 ...
 call rk4f_3d_infperiodic_age(phi_proc,th_proc,kappa_proc,&
...
end program fault_3d_infperiodic_aging
