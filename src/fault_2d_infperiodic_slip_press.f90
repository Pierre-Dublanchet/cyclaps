...
program fault_2d_infperiodic_slip_press
...
implicit none
integer :: iter,i
integer :: irec,irecp,irecevt,irecloc,recpok,recok,reclocok,isevt
...
real*8, dimension(:), allocatable :: p_proc,prate_proc
...
allocate(p_proc(cc%nvalpr),prate_proc(cc%nvalpr))
...
call rk4f_2d_infperiodic_slip_p(t,phi_proc,th_proc,kappa_proc,&
                  a_proc,b_proc,dc_proc,s_proc,p_proc,cc,cm,chy,dt,dt0)
call press_1d(p_proc,t+dt0,cm,chy,cc)
...
end program fault_2d_infperiodic_slip_press
