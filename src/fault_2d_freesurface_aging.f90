...
program fault_2d_freesurface_aging
...
call rk4f_2d_freesurface_age(phi_proc,th_proc,tbp_proc,Kstatic_proc,&
...
end program fault_2d_freesurface_aging
...
include 'rk4f_2d_freesurface_age.f90'
