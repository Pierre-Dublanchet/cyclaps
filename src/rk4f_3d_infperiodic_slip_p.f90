...
subroutine rk4f_3d_infperiodic_slip_p(t,phi_proc,th_proc,kappa_proc,&
...
real*8, dimension(cc%nvalpr) :: p_proc,prate_proc
...
do while ((passtep .eq. 0) .and. (iterrk .le. cc%paramdt(1)))
 ...
 call press_2d(p_proc,t,cm,chy,cc)
 call pressrate_2d(prate_proc,t,cm,chy,cc)
 

  do i=1,cc%nvalpr
        l1_proc(i)=frns_slip_p(phi_proc(i),th_proc(i),sk_proc(i),tbp_proc(i),p_proc(i),prate_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m1_proc(i)=grns_slip_p(phi_proc(i),th_proc(i),p_proc(i),prate_proc(i),&
...
ddt=cc%rka(2)*dt
 ...
 call press_2d(p_proc,t+ddt,cm,chy,cc)
 call pressrate_2d(prate_proc,t+ddt,cm,chy,cc)

  do i=1,cc%nvalpr
       
        l2_proc(i)=frns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),p_proc(i),prate_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m2_proc(i)=grns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),p_proc(i),prate_proc(i),&
        					b_proc(i),dc_proc(i),s_proc(i),cm)
...
ddt=cc%rka(3)*dt
 ...
 call pressrate_2d(prate_proc,t+ddt,cm,chy,cc)
  ...
  do i=1,cc%nvalpr
        l3_proc(i)=frns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),p_proc(i),prate_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m3_proc(i)=grns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),p_proc(i),prate_proc(i),&
        					b_proc(i),dc_proc(i),s_proc(i),cm)
  end do
...
ddt=cc%rka(4)*dt
 ...
 call pressrate_2d(prate_proc,t+ddt,cm,chy,cc)
  ...
  do i=1,cc%nvalpr
        l4_proc(i)=frns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),p_proc(i),prate_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m4_proc(i)=grns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),p_proc(i),prate_proc(i),&
        					b_proc(i),dc_proc(i),s_proc(i),cm)
  end do
...
ddt=cc%rka(5)*dt
 ...
 call pressrate_2d(prate_proc,t+ddt,cm,chy,cc)
  ...
  do i=1,cc%nvalpr
        l5_proc(i)=frns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),p_proc(i),prate_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m5_proc(i)=grns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),p_proc(i),prate_proc(i),&
        					b_proc(i),dc_proc(i),s_proc(i),cm)
  end do
...
ddt=cc%rka(6)*dt
 ...
 call pressrate_2d(prate_proc,t+ddt,cm,chy,cc)
  ...
  do i=1,cc%nvalpr
        l6_proc(i)=frns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),p_proc(i),prate_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m6_proc(i)=grns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),p_proc(i),prate_proc(i),&
        					b_proc(i),dc_proc(i),s_proc(i),cm)
  end do
...
end subroutine rk4f_3d_infperiodic_slip_p
