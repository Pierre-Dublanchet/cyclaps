...
program fault_2d_infperiodic_aging

use mod_cst_fault_rns
use netcdf
implicit none
integer :: iter,i
integer :: irec,irecloc,irecp,irecevt,recok,reclocok,recpok,isevt
...
call rk4f_2d_infperiodic_age(phi_proc,th_proc,kappa_proc,&
...
end program fault_2d_infperiodic_aging
...
include 'rk4f_2d_infperiodic_age.f90'
