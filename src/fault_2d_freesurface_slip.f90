...
program fault_2d_freesurface_slip
...
call rk4f_2d_freesurface_slip(phi_proc,th_proc,tbp_proc,Kstatic_proc,&
...
end program fault_2d_freesurface_slip
...
include 'rk4f_2d_freesurface_slip.f90'
