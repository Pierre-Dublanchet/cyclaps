...
program fault_3d_infperiodic_regslip
...
do iter=1,cc%niter
  ...
  if ((recok .eq. 1) .or. (recpok .eq. 1) .or. (reclocok .eq. 1) .or. (recphvcok .eq. 1)) then
     ...
     !--compute frictional shear stress+stress perturbation--!
     do i=1,cc%nvalpr
 ...
 call rk4f_3d_infperiodic_regslip(phi_proc,th_proc,kappa_proc,&
...
end program fault_3d_infperiodic_regslip
