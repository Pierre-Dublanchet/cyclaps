...
program fault_3d_infperiodic_aging_pnl
...
call rk4f_3d_infperiodic_age_pnl(t,phi_proc,th_proc,kappa_proc,&
...
end program fault_3d_infperiodic_aging_pnl
...
include 'ci2xy.f90'
include 'xy2ci.f90'
include 'frns_age_p.f90'
include 'grns_age_p.f90'
include 'elastic_kernel_3d_infperiodic.f90'
include 'plan_static_stress_periodic.f90'
include 'rk4f_3d_infperiodic_age_pnl.f90'
