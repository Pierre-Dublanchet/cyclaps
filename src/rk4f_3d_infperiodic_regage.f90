...
subroutine rk4f_3d_infperiodic_regage(phi_proc,th_proc,kappa_proc,&
...
real*8 :: t
real*8 :: dt,ddt,dt0,frns_regage,grns_age
...
do while ((passtep .eq. 0) .and. (iterrk .le. cc%paramdt(1)))
  ...
  call tbp_rns_3d_infperiodic_dssext(tbp_proc,phi_proc,cm,cc,t)
  call plan_static_stress_periodic(sk_proc,phi_proc,kappa_proc,cc)
  
 

  do i=1,cc%nvalpr
        l1_proc(i)=frns_regage(phi_proc(i),th_proc(i),sk_proc(i),tbp_proc(i),a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
...
ddt=cc%rka(2)*dt
  ...
  call tbp_rns_3d_infperiodic_dssext(tbp_proc,phi_proc+dphi_proc,cm,cc,t+ddt)
...
!print*,' hello 7.3 '
  do i=1,cc%nvalpr
        ...
        l2_proc(i)=frns_regage(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
...
!print*,' hello 7.5 '
  do i=1,cc%nvalpr
        l3_proc(i)=frns_regage(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
        							a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
...
!print*,' hello 7.7 '
  do i=1,cc%nvalpr
        l4_proc(i)=frns_regage(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
        							a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
...
!print*,' hello 7.9 '
  do i=1,cc%nvalpr
        l5_proc(i)=frns_regage(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
        							a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
...
!print*,' hello 7.11 '
  do i=1,cc%nvalpr
        l6_proc(i)=frns_regage(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
        							a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
...
end subroutine rk4f_3d_infperiodic_regage
