...
subroutine init_rns_3d_rg_p(a_proc,b_proc,dc_proc,s_proc,phi_proc,th_proc,u_proc,p_proc,cm,cc,cr)
...
real*8 :: x,y,r
real*8, dimension(cc%nvalpr) :: a_proc,b_proc,dc_proc,s_proc,p_proc
...
end subroutine init_rns_3d_rg_p
