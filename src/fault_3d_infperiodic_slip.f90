...
program fault_3d_infperiodic_slip
...
do iter=1,cc%niter
 ...
 call rk4f_3d_infperiodic_slip(phi_proc,th_proc,kappa_proc,&
...
end program fault_3d_infperiodic_slip
...
include 'rk4f_3d_infperiodic_slip.f90'
