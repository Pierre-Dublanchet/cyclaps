...
subroutine rk4f_2d_cr_age(phi_proc,th_proc,tbp_proc,kappa_proc,v0_proc,rkr,rks,ad,&
                  a_proc,b_proc,dc_proc,s_proc,cc,cm,dt,dt0)

use mod_cst_fault_rns
implicit none
integer :: i,passtep,iterrk,j
integer, dimension(nprocs) :: rkr,rks,ad
real*8 :: dt,dt0,frns_age,grns_age
...
!print*,sk_proc
  ...
  do i=1,cc%nvalpr
        l1_proc(i)=frns_age(phi_proc(i),th_proc(i),sk_proc(i),tbp_proc(i),a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m1_proc(i)=grns_age(phi_proc(i),th_proc(i),dc_proc(i))
  end do
...
!print*,' hello 7.3 '
  do i=1,cc%nvalpr
        ...
        l2_proc(i)=frns_age(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
        							a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m2_proc(i)=grns_age(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),dc_proc(i))
...
!print*,' hello 7.5 '
  do i=1,cc%nvalpr
        l3_proc(i)=frns_age(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
        							a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m3_proc(i)=grns_age(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),dc_proc(i))
  end do
!print*,' hello 7.6 '
  call MPI_BARRIER(MPI_COMM_WORLD,code)
...
!print*,' hello 7.7 '
  do i=1,cc%nvalpr
        l4_proc(i)=frns_age(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
        							a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m4_proc(i)=grns_age(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),dc_proc(i))
  end do
!print*,' hello 7.8 '
  call MPI_BARRIER(MPI_COMM_WORLD,code)
...
!print*,' hello 7.9 '
  do i=1,cc%nvalpr
        l5_proc(i)=frns_age(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
        							a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m5_proc(i)=grns_age(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),dc_proc(i))
  end do
!print*,' hello 7.10 '
  call MPI_BARRIER(MPI_COMM_WORLD,code)
...
!print*,' hello 7.11 '
  do i=1,cc%nvalpr
        l6_proc(i)=frns_age(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
        							a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m6_proc(i)=grns_age(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),dc_proc(i))
  end do
...
if (iterrk .eq. cc%paramdt(1)+1) then
	print*,'did not find solution to sufficient accuracy, error = ',error
end if
