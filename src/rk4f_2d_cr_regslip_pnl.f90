...
subroutine rk4f_2d_cr_regslip_pnl(t,phi_proc,th_proc,kappa_proc,v0_proc,rkr,rks,ad,&
...
real*8 :: t,dt,ddt,dt0
real*8 :: frns_regslip_p,grns_slip_p
real*8 :: p0,pe,d0,de
...
do while ((passtep .eq. 0) .and. (iterrk .le. cc%paramdt(1)))
  ...
  do i=1,cc%nvalpr
        l1_proc(i)=frns_regslip_p(phi_proc(i),th_proc(i),sk_proc(i),tbp_proc(i),p_proc(i),k1_proc(i),&
...
ddt=cc%rka(2)*dt
  ...
  do i=1,cc%nvalpr
        l2_proc(i)=frns_regslip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
					p_proc(i)+dp_proc(i),k2_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m2_proc(i)=grns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),p_proc(i)+dp_proc(i),k2_proc(i),&
        					b_proc(i),dc_proc(i),s_proc(i),cm)
  end do
...
ddt=cc%rka(3)*dt
  ...
  do i=1,cc%nvalpr
        l3_proc(i)=frns_regslip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
					p_proc(i)+dp_proc(i),k3_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m3_proc(i)=grns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),p_proc(i)+dp_proc(i),k3_proc(i),&
        					b_proc(i),dc_proc(i),s_proc(i),cm)
  end do
...
ddt=cc%rka(4)*dt
 ...
 call diffu(diffu_proc,phi_proc+dphi_proc,th_proc+dth_proc,p_proc+dp_proc,&
  ...
  do i=1,cc%nvalpr
        l4_proc(i)=frns_regslip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
					p_proc(i)+dp_proc(i),k4_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m4_proc(i)=grns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),p_proc(i)+dp_proc(i),k4_proc(i),&
        					b_proc(i),dc_proc(i),s_proc(i),cm)
  end do
...
ddt=cc%rka(5)*dt
 ...
 call diffu(diffu_proc,phi_proc+dphi_proc,th_proc+dth_proc,p_proc+dp_proc,&
  ...
  do i=1,cc%nvalpr
        l5_proc(i)=frns_regslip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
					p_proc(i)+dp_proc(i),k5_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m5_proc(i)=grns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),p_proc(i)+dp_proc(i),k5_proc(i),&
        					b_proc(i),dc_proc(i),s_proc(i),cm)
  end do
...
ddt=cc%rka(6)*dt
 ...
 call diffu(diffu_proc,phi_proc+dphi_proc,th_proc+dth_proc,p_proc+dp_proc,&
  ...
  do i=1,cc%nvalpr
        l6_proc(i)=frns_regslip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
					p_proc(i)+dp_proc(i),k6_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m6_proc(i)=grns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),p_proc(i)+dp_proc(i),k6_proc(i),&
        					b_proc(i),dc_proc(i),s_proc(i),cm)
  end do
...
end subroutine rk4f_2d_cr_regslip_pnl
