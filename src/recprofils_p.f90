...
subroutine recprofils_p(recpok,cm,chy,cr,cc,phi,th,u,tau,p,irecp,t,dtrecp)
...
real*8, dimension(cc%n) :: phi,th,u,tau,p
 character(len=10) :: numf
     ...
     if (rang .eq. 0) then
            ...
            statusnetcdf=nf90_put_var(ncid, varid(7), dtrecp*cm%dc0/cm%vb0)
