...
subroutine rk4f_3d_infperiodic_age_pnl(t,phi_proc,th_proc,kappa_proc,&
...
real*8 :: t,ddt,dt,dt0,frns_age_p,grns_age_p
...
!ddt=cc%rka(2)*dt
 ...
 call pressrate_nl2d(k2_proc,p_proc+dp_proc,p0,pe,diffu_proc,d0,de,cm,chy,cc)
  ...
  do i=1,cc%nvalpr
        ...
        l2_proc(i)=frns_age_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),p_proc(i),k2_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m2_proc(i)=grns_age_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),p_proc(i),k2_proc(i),&
        					b_proc(i),dc_proc(i),s_proc(i),cm)
...
!ddt=cc%rka(3)*dt
 ...
 call pressrate_nl2d(k3_proc,p_proc+dp_proc,p0,pe,diffu_proc,d0,de,cm,chy,cc)
  ...
  do i=1,cc%nvalpr
        l3_proc(i)=frns_age_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),p_proc(i),k3_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m3_proc(i)=grns_age_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),p_proc(i),k3_proc(i),&
        					b_proc(i),dc_proc(i),s_proc(i),cm)
  end do
...
!ddt=cc%rka(4)*dt
 ...
 call pressrate_nl2d(k4_proc,p_proc+dp_proc,p0,pe,diffu_proc,d0,de,cm,chy,cc)
  ...
  do i=1,cc%nvalpr
        l4_proc(i)=frns_age_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),p_proc(i),k4_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m4_proc(i)=grns_age_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),p_proc(i),k4_proc(i),&
        					b_proc(i),dc_proc(i),s_proc(i),cm)
  end do
...
!ddt=cc%rka(5)*dt
 ...
 call pressrate_nl2d(k5_proc,p_proc+dp_proc,p0,pe,diffu_proc,d0,de,cm,chy,cc)
  ...
  do i=1,cc%nvalpr
        l5_proc(i)=frns_age_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),p_proc(i),k5_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m5_proc(i)=grns_age_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),p_proc(i),k5_proc(i),&
        					b_proc(i),dc_proc(i),s_proc(i),cm)
  end do
...
!ddt=cc%rka(6)*dt
 ...
 call pressrate_nl2d(k6_proc,p_proc+dp_proc,p0,pe,diffu_proc,d0,de,cm,chy,cc)
  ...
  do i=1,cc%nvalpr
        l6_proc(i)=frns_age_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),p_proc(i),k6_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m6_proc(i)=grns_age_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),p_proc(i),k6_proc(i),&
        					b_proc(i),dc_proc(i),s_proc(i),cm)
  end do
...
end subroutine rk4f_3d_infperiodic_age_pnl
