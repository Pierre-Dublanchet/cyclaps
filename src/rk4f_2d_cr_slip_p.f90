...
subroutine rk4f_2d_cr_slip_p(t,phi_proc,th_proc,kappa_proc,v0_proc,rkr,rks,ad,&
...
real*8 :: t,dt,ddt,dt0,frns_slip_p,grns_slip_p
...
do while ((passtep .eq. 0) .and. (iterrk .le. cc%paramdt(1)))
  ...
  call tbp_rns_2d_cr(tbp_proc,phi_proc,cm,cc)
   call lin_static_stress_cr(sk_proc,phi_proc,kappa_proc,v0_proc,rkr,rks,ad,cm,cc)
...
ddt=cc%rka(2)*dt
  ...
  call tbp_rns_2d_cr(tbp_proc,phi_proc+dphi_proc,cm,cc)
 call lin_static_stress_cr(sk_proc,phi_proc+dphi_proc,kappa_proc,v0_proc,rkr,rks,ad,cm,cc)
...
end subroutine rk4f_2d_cr_slip_p
