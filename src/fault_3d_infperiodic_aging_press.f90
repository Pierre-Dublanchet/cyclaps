...
program fault_3d_infperiodic_aging_press
...
call rk4f_3d_infperiodic_age_p(t,phi_proc,th_proc,kappa_proc,&
...
end program fault_3d_infperiodic_aging_press
...
include 'rk4f_3d_infperiodic_age_p.f90'
