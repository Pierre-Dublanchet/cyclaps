...
subroutine rk4f_2d_cr_slip_pnl(t,phi_proc,th_proc,kappa_proc,v0_proc,rkr,rks,ad,&
...
real*8 :: t,dt,ddt,dt0
real*8 :: frns_slip_p,grns_slip_p
real*8 :: p0,pe,d0,de
...
ddt=cc%rka(2)*dt
  ...
  do i=1,cc%nvalpr
        l2_proc(i)=frns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
...
ddt=cc%rka(3)*dt
  ...
  do i=1,cc%nvalpr
        l3_proc(i)=frns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
...
ddt=cc%rka(4)*dt
 ...
 call diffu(diffu_proc,phi_proc+dphi_proc,th_proc+dth_proc,p_proc+dp_proc,&
  ...
  do i=1,cc%nvalpr
        l4_proc(i)=frns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
...
call lin_static_stress_cr(sk_proc,phi_proc+dphi_proc,kappa_proc,v0_proc,rkr,rks,ad,cm,cc)
 call diffu(diffu_proc,phi_proc+dphi_proc,th_proc+dth_proc,p_proc+dp_proc,&
  ...
  do i=1,cc%nvalpr
        l5_proc(i)=frns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
...
ddt=cc%rka(6)*dt
 ...
 call diffu(diffu_proc,phi_proc+dphi_proc,th_proc+dth_proc,p_proc+dp_proc,&
  ...
  do i=1,cc%nvalpr
        l6_proc(i)=frns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),&
...
end subroutine rk4f_2d_cr_slip_pnl
