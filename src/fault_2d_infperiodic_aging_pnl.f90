...
program fault_2d_infperiodic_aging_pnl
...
call rk4f_2d_infperiodic_age_pnl(t,phi_proc,th_proc,kappa_proc,&
...
end program fault_2d_infperiodic_aging_pnl
...
include 'rk4f_2d_infperiodic_age_pnl.f90'
