...
subroutine init_rns_2d_rg_p_seas(a_proc,b_proc,dc_proc,s_proc,phi_proc,th_proc,u_proc,p_proc,qdarcy_proc,cm,cc,cr)
...
real*8, dimension(cc%nvalpr) :: phi_proc,th_proc,u_proc,p_proc,qdarcy_proc
...
do i=1,cc%nvalpr
    ...
    th_proc(i)=log(dc_proc(i)/cm%vb0)-(a_proc(i)/b_proc(i))*phi_proc(i)+&
             (a_proc(i)/b_proc(i))*log(cm%vb0)+&
             (a_proc(i)/b_proc(i))*log(exp(2.92d7/(a_proc(i)*s_proc(i)))-exp(-2.92d7/(a_proc(i)*s_proc(i))))-&
             cm%mu0/b_proc(i)  
...
end subroutine init_rns_2d_rg_p_seas
