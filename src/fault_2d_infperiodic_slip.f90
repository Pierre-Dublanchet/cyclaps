...
program fault_2d_infperiodic_slip

use mod_cst_fault_rns
use netcdf
implicit none
integer :: iter,i
integer :: irec,irecloc,irecp,irecevt,recpok,recok,reclocok,isevt
integer :: nelevt_proc,nelevt_proc0
integer, dimension(4) :: iterex
integer, dimension(:), allocatable :: nelevt,vrecpoints
real*8 :: t,dt,dt0,dtrec,dtrecloc,dtrecp
real*8 :: start
...
call rk4f_2d_infperiodic_slip(phi_proc,th_proc,kappa_proc,&
...
end program fault_2d_infperiodic_slip
...
include 'rk4f_2d_infperiodic_slip.f90'
