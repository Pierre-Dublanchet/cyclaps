...
program fault_2d_freesurface_aging_pnl
...
do iter=1,cc%niter
 ...
 call rk4f_2d_freesurface_age_pnl(t,phi_proc,th_proc,tbp_proc,Kstatic_proc,&
...
end program fault_2d_freesurface_aging_pnl
...
include 'rk4f_2d_freesurface_age_pnl.f90'
