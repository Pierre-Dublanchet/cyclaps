...
subroutine rk4f_3d_infperiodic_slip_pnl(t,phi_proc,th_proc,kappa_proc,&
...
real*8 :: t,ddt,dt,dt0,frns_slip_p,grns_slip_p
...
do while ((passtep .eq. 0) .and. (iterrk .le. cc%paramdt(1)))
  ...
  call tbp_rns_3d_infperiodic(tbp_proc,phi_proc,cm,cc)
  call plan_static_stress_periodic(sk_proc,phi_proc,kappa_proc,cc)
  call diffu(diffu_proc,phi_proc,th_proc,p_proc,s_proc,a_proc,b_proc,dc_proc,cm,chy,cc)
  call transfer_end_points_2d(diffu_proc,p_proc,p0,pe,d0,de,cc)
  call pressrate_nl2d(k1_proc,p_proc,p0,pe,diffu_proc,d0,de,cm,chy,cc)

  do i=1,cc%nvalpr
        l1_proc(i)=frns_slip_p(phi_proc(i),th_proc(i),sk_proc(i),tbp_proc(i),p_proc(i),k1_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m1_proc(i)=grns_slip_p(phi_proc(i),th_proc(i),p_proc(i),k1_proc(i),&
...
!ddt=cc%rka(2)*dt
 ...
 call tbp_rns_3d_infperiodic(tbp_proc,phi_proc+dphi_proc,cm,cc)
 call  plan_static_stress_periodic(sk_proc,phi_proc+dphi_proc,kappa_proc,cc)
 call diffu(diffu_proc,phi_proc+dphi_proc,th_proc+dth_proc,p_proc+dp_proc,&
		s_proc,a_proc,b_proc,dc_proc,cm,chy,cc)
 call transfer_end_points_2d(diffu_proc,p_proc+dp_proc,p0,pe,d0,de,cc)
 call pressrate_nl2d(k2_proc,p_proc+dp_proc,p0,pe,diffu_proc,d0,de,cm,chy,cc)

  do i=1,cc%nvalpr
       
        l2_proc(i)=frns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),p_proc(i),k2_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m2_proc(i)=grns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),p_proc(i),k2_proc(i),&
        					b_proc(i),dc_proc(i),s_proc(i),cm)
...
!ddt=cc%rka(3)*dt
 ...
 call diffu(diffu_proc,phi_proc+dphi_proc,th_proc+dth_proc,p_proc+dp_proc,&
		s_proc,a_proc,b_proc,dc_proc,cm,chy,cc)
 call transfer_end_points_2d(diffu_proc,p_proc+dp_proc,p0,pe,d0,de,cc)
 call pressrate_nl2d(k3_proc,p_proc+dp_proc,p0,pe,diffu_proc,d0,de,cm,chy,cc)
 

  do i=1,cc%nvalpr
        l3_proc(i)=frns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),p_proc(i),k3_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m3_proc(i)=grns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),p_proc(i),k3_proc(i),&
        					b_proc(i),dc_proc(i),s_proc(i),cm)
  end do
...
!ddt=cc%rka(4)*dt
 ...
 call diffu(diffu_proc,phi_proc+dphi_proc,th_proc+dth_proc,p_proc+dp_proc,&
		s_proc,a_proc,b_proc,dc_proc,cm,chy,cc)
 call transfer_end_points_2d(diffu_proc,p_proc+dp_proc,p0,pe,d0,de,cc)
 call pressrate_nl2d(k4_proc,p_proc+dp_proc,p0,pe,diffu_proc,d0,de,cm,chy,cc)
 

  do i=1,cc%nvalpr
        l4_proc(i)=frns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),p_proc(i),k4_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m4_proc(i)=grns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),p_proc(i),k4_proc(i),&
        					b_proc(i),dc_proc(i),s_proc(i),cm)
  end do
...
!ddt=cc%rka(5)*dt
 ...
 call diffu(diffu_proc,phi_proc+dphi_proc,th_proc+dth_proc,p_proc+dp_proc,&
		s_proc,a_proc,b_proc,dc_proc,cm,chy,cc)
 call transfer_end_points_2d(diffu_proc,p_proc+dp_proc,p0,pe,d0,de,cc)
 call pressrate_nl2d(k5_proc,p_proc+dp_proc,p0,pe,diffu_proc,d0,de,cm,chy,cc)
 

  do i=1,cc%nvalpr
        l5_proc(i)=frns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),p_proc(i),k5_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m5_proc(i)=grns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),p_proc(i),k5_proc(i),&
        					b_proc(i),dc_proc(i),s_proc(i),cm)
  end do
...
!ddt=cc%rka(6)*dt
 ...
 call diffu(diffu_proc,phi_proc+dphi_proc,th_proc+dth_proc,p_proc+dp_proc,&
		s_proc,a_proc,b_proc,dc_proc,cm,chy,cc)
 call transfer_end_points_2d(diffu_proc,p_proc+dp_proc,p0,pe,d0,de,cc)
 call pressrate_nl2d(k6_proc,p_proc+dp_proc,p0,pe,diffu_proc,d0,de,cm,chy,cc)

  do i=1,cc%nvalpr
        l6_proc(i)=frns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),sk_proc(i),tbp_proc(i),p_proc(i),k6_proc(i),&
        				a_proc(i),b_proc(i),dc_proc(i),s_proc(i),cm)
        m6_proc(i)=grns_slip_p(phi_proc(i)+dphi_proc(i),th_proc(i)+dth_proc(i),p_proc(i),k6_proc(i),&
        					b_proc(i),dc_proc(i),s_proc(i),cm)
  end do
...
end subroutine rk4f_3d_infperiodic_slip_pnl
